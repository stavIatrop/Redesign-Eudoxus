        ...
        <div class="row infoContainer">
          <div class="col-md-2">
            <div class="row" style="height:25%">
              <button class="infoButton btn btn-outline-dark rounded-0 active"><i class="fas fa-graduation-cap"></i>    Φοιτητής</button>
            </div>
            <div class="row" style="height:25%">
              <button class="infoButton btn btn-outline-dark rounded-0"><i class="fas fa-book"></i>    Εκδότης</button>
            </div>
            <div class="row" style="height:25%">
              <button class="infoButton btn btn-outline-dark rounded-0"><i class="fas fa-landmark"></i>    Γραμματεία</button>
            </div>
            <div class="row" style="height:25%">
              <button class="infoButton btn btn-outline-dark rounded-0"><i class="fas fa-truck"></i>    <span>Σημείο<br>Διανομής</span></button>
            </div>
          </div>
          <div class="col-md-10">
